...
// THE OLD GREETINGS RESOURCE CODE :)) Cause I didn't want to delete it. Call me sentimental. Or lazy. Or both. Actually, this is really for reference purposes. I'm not sentimental. I'm just lazy. (I'm kidding. I'm sentimental. And lazy. And both. And neither. I'm just a person. A person who's writing a lot of comments. I should stop now. I'm stopping now. Bye. I'm done. I'm really done. I'm not kidding *(some of these were generated by Copilot.. so it's Copilot calling me lazy XD **(good job reading this long line of comment...why? Why did you just take the time to read all of this? That's kinda weird you know.. ¯\_(ツ)_/¯)** )*)
